...
import sliderAr from '../../_utils/slider-en.gif'
    ...
    return (
        <Grid>
            ...
            <Grid container justifyContent="" marginTop={2}>
                <i style={{ marginTop: 0 }}>
                    {IntroLabelsAr.cptFood},
                    {IntroLabelsAr.cptAbstract},
                    {IntroLabelsAr.cptEmotion},
                    {IntroLabelsAr.cptWeather}<br />
                </i>
            </Grid>
            <br />
            ...
            <div style={{ marginTop: 5 }}>
                <img src={sliderAr} alt={IntroLabelsAr.sliderAltText} width="55%" />
            </div>
